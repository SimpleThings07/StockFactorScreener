...
def get_operating_income_ttm (stock, ticker):
    ...
    if income_statement is None or income_statement.empty:
        ...
        raise ValueError(f"No Income Statement (quarterly) data found (Ticker: {ticker}). Cannot calculate EBIT/TEV ratio!")
...
def get_operating_income_annual (stock, ticker):
    ...
    if income_statement is None or income_statement.empty:
        # Throw exception if the data is not available
        raise ValueError(f"No Income Statement (annual) data found (Ticker: {ticker}). Cannot calculate EBIT/TEV ratio!")
    ...
    if 'Operating Income' in income_statement.columns:
        ...
        if not operating_income_annual or len(operating_income_annual) < 1:
            ...
            raise ValueError(f"'Operating Income' (annual) data is not available in the Income Statement (Ticker: {ticker}). Cannot calculate EBIT/TEV ratio!")
    ...
    # Use 'Pretax Income' if 'Operating Income' is not available as fallback
        ...
        if not pretax_income_annual or len(pretax_income_annual) < 1:
            # If the list is empty, raise an exception
            raise ValueError(f"'Pretax Income' (annual) data is not available in the Income Statement (Ticker: {ticker}). Cannot calculate EBIT/TEV ratio!")
